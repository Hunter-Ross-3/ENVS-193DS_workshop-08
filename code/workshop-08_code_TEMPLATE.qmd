...
drought_exp_clean <- drought_exp |> # starting with the drought_exp object
  ...
  # making sure water_treatment is a facotr and ordering the levels
...
```{r sla}
#| fig-width: 10 #10 inch standardized figure so it fits
...
ggplot(data = drought_exp_clean,
  ...
  labs(x = "Water treatment",
       y = "Total mass (g)",
       title = "Average total mass is higher in well water \ntreatments than drought stressed \ntreatments") +
  # taking out legend
...
```{r model-summary}
summary(model4)
#reference level for water_treatment is water_stressed
...
On average, plant masses in drought stressed conditions were0.12 $\pm$ 0.02g less than plant masses in well watered conditions across species
